...
$sql = "UPDATE users SET address='" . $_POST["add"] . "',phonenum='" . $_POST["phonenum"] . "',email='" . $_POST["email"] . "',username='" . $_POST["username"] . "' WHERE userID='" . $_POST["userID"] . "'";
...
<div class="fixed-bg"> 
<p style = "color : white" > <strong> Profile updated successfully !! </strong></p>
</div>
