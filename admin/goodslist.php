...
<img src="/parcelUMP/css/logo-rasmi-ump.png"width="130" height="55" ></a>
</p>
</div>
<div class = "b">
&nbsp; &nbsp; &nbsp; &nbsp;
...
<div class="fixed-bg">
<p style = "color : white" > <strong>GOODS LIST</strong></p>
</div>
...
?>
<br><br>
<button class="input"  onclick="document.location='recepient.php'">Back</button>
  </div>
