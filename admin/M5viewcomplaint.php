...
<form action="M5delete.php" method="POST">		
...
<br>
<form action="M5update.php" method="POST">		
	<input type="" name="complaintID" value="<?php echo (isset($complaintID))?$complaintID:'';?>" hidden>
	
<button class="input" type ="submit" >Update</button></td>
...
?>
<br>
<button class="input input1" onclick="document.location='adminPage.php'">Back</button>
