...
<div class="fixed-bg"> 
<p style = "color : white" > <strong> <?php echo $row['usertype'] ?> Profile </strong></p>
</div>
...
<br><br>
<button class="input" onclick="document.location='updateUser01.php'">Update</button>
<button class="input" onclick="document.location='deleteUser01.php'">Delete</button>
