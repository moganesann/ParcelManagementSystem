...
$sql="SELECT studentID,DATEDIFF(dateGoodsCollectRecipient,dateGoodsCollectOfficer) as number FROM warden WHERE status='collected'";
...
<script type="text/javascript" src="https://www.gstatic.com/charts/loader.js"></script>  
           ...
           {  
                var data = google.visualization.arrayToDataTable([  
                          ...
                          {  
                               echo "['".$row["studentID"]."', ".$row["number"]."],";
                          }  
                          ?>  
                     ]);  
                var options = {  
                      title: 'Percentage of Total Duration (Days)',  
                      //is3D:true,  
                      pieHole: 0.4  
                     };  
...
<div style="width:900px; justify-content: center; align-items: center;">  
