...
<div class="fixed-bg"> 
<p style = "color : white" > <strong> Create New User Profile </strong></p>
</div>
...
<div class="containers">
    <form action="newUser.php" method="POST">
		...
		<option value="Warden">Residential Warden</option>
		<option value="Residents">UMP Residents</option>
  </select>
  
  <br><br>
		<input class="input" type="reset">
        <input class="input" type="submit" value ="Register Now">
</form>
