...
<?php
	...
	$sqlparcel = "SELECT count(typegoods) AS totalp FROM activelist WHERE address = '$numaddress_rows' ";
	$resultparcel=mysqli_query($link,$sqlparcel);
	$valuesparcel=mysqli_fetch_assoc($resultparcel);
	$numparcel_rows=$valuesparcel['totalp'];
...
<div class="row">
  <div class="column left" >
    <h3> Report </h3>
	<form action="M2report2.php" method = "post">
	Start date:<input type="date" name="startdate" placeholder="yyyy-mm-dd" min="1997-01-01" max="2030-12-31" value=<?php echo $startdate;?>>
	...
	<br>
		<button class="input" onclick="document.location='M2visualreport.php'">View Chart</button>
	</div>
