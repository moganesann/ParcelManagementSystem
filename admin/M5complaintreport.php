...
$query="SELECT type, count(*) as number FROM complaint GROUP BY type";
...
<script type="text/javascript" src="https://www.gstatic.com/charts/loader.js"></script>  
           ...
           {  
                ...
                var options = {  
                      title: 'Percentage of Complaint Type',  
                      //is3D:true,  
                      pieHole: 0.4  
                     };  
...
<div class="fixed-bg">
<div class = "container"> 
<p style = "color : white" > <strong>Complaint Report</strong></p>
</div>
</div>

<div class="row">
  <div class="column left" >
  <div  id="piechart" style="width: 1100px; height: 700px; padding: 100px; "></div> 
<button class="input input1" onclick="document.location='M5showcompreport.php'">Back</button>  
  </div>
