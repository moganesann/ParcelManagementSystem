...
$sql = "INSERT INTO users (userID,username,password,address,phonenum,usertype,email) VALUES ('$userID','$username', '$password', '$add', '$phonenum', '$usertype', '$email')";
...
<div class="fixed-bg">
<p style = "color : white" > <strong> Users added successfully !! </strong></p>
</div>
...
<div class="containers">
    ...
    <br>
    <button class="input" onclick="document.location='adminPage.php'">Back</button>
</div>
