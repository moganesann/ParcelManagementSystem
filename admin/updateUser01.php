...
<div class="fixed-bg"> 
<p style = "color : white" > <strong> Update User Profile </strong></p>
</div>


<div class="containers">
     <form action="updateUser02.php" method="POST">
<p> <strong> Please fill in new details </strong></p>
<br>
<input type="text" name="userID" value="<?php echo (isset($value))?$value:'';?>" readonly>
