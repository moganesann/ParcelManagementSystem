...
<div class="fixed-bg">
<div class = "container"> 
<p style = "color : white" > <strong>Complaint Area</strong></p>
</div>
</div>
...
<div class="row">
  ...
  <form action="addcomplaint.php" method= "post" enctype="multipart/form-data">
	<input type="text" id="userid" name="userid" placeholder="Enter your ID here....">
...
<br>
<p>Select Image to Upload: <br><br>
    <input type="file" name="file"></p>
    
<br><br>
<textarea id="comment" name="comment" placeholder ="Write your complaint here..."></textarea>
<input type="checkbox" id="unsolve" name="status" value="unsolve" required>
<label for="unsolve" >I have fill the form correctly</label>	
<br>
<input class="input input1" type="submit" name="submit" value ="Submit">
</form>
  </div>
