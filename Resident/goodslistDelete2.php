...
<div class ="containers">
    <p style="text-align:center;font-size:20px;"> <strong> Delete the information successfully!! </strong></p>
    <br><br> 
	<button class="input" onclick="window.location.href='goodslistReport.php'">Back</button>
  </div>
