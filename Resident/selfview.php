...
<meta charset="UTF-8">
<title> Welcome to Complaint Page </title>
</head>
<body >
<header>
...
<div class="fixed-bg">
<div class = "container"> 
<p style = "color : white" > <strong>Search Your Complaint</strong></p>
</div>
</div>
...
<div class="row">
  ...
  <form action="searchcomplaint.php" method="post">
        ...
        <input type="text" id="userid" name="userid" placeholder="Enter the ID to search...." required>
        <br>
        <input class="input input1" type="submit" value ="GO">
		</div>
</form>
  </div>
