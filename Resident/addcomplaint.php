...
if(isset($_POST["submit"]) && !empty($_FILES["file"]["name"])){
    ...
    if(in_array($fileType, $allowTypes)){
        ...
        if(move_uploaded_file($_FILES["file"]["tmp_name"], $targetFilePath)){
            ...
            $insert = $link->query("INSERT INTO complaint (userID,type,comment,file_name,status) VALUES ('$userid','$type', '$comment','".$fileName."','$status')");
...
<div class="fixed-bg">
<div class = "container"> 
<p style = "color : white" > <strong>Done!</strong></p>
</div>
</div>
