...
$sql="UPDATE warden SET dateGoodsCollectRecipient='$date',status='".$_POST['status']."',comments='".$_POST['comments']."' WHERE studentID='".$_POST['id']."'";
...
<div class ="containers">
    <p style="text-align:center;font-size:20px;"> <strong> Update status successfully </strong></p>

    <br> <br> <button class="input" onclick="window.location.href='goodslistSearchstatus.php'">Back</button>
    </div>
