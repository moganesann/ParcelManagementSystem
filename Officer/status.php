...
$sql = "SELECT * FROM activelist WHERE id ='" . $_REQUEST["id"] . "'";
...
<div class="row">
  <div class="column left" >
   ...
   if(mysqli_num_rows($result) > 0){ while($row = mysqli_fetch_array($result)){ ?>
	...
	<input type="hidden" name="id" value="<?php echo (isset($_REQUEST['id']))?$_REQUEST['id']:'';?>" readonly>
    ...
    <!-- Added update dcollected -->
	<tr>
		<td>Date of Goods Collected :</td>
		<td>
		 <input type="date" name="dcollected" id="dcollected" >
		</td>
	</tr>
	<tr>
		<td>Sender's name  :</td>
	...
	<tr>
			...
			<td><input type="checkbox" id="received" name="status" value="received">
