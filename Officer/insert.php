...
<div class="fixed-bg"> 
<p style = "color : white" > <strong>ADD</strong></p>
</div>
...
<div class="row">
  ...
  <table class="table3" border='1'>
	...
	<td style="background-color:white;">
        <input type="text1" name="name" id="name" placeholder="Student Name" style="text-align:center;">
	</td>
    </tr>
    <tr>
	<td>Student's ID:</td>
	<td style="background-color:white;">
        <input type="text1" name="id" id="id" placeholder="Student ID" style="text-align:center;">
	</td>
    </tr>
	<tr>
	<td>Phone Number:</td>
    <td style="background-color:white;">
        <input type="text1" name="phone" id="phone" placeholder="Phone Number" style="text-align:center;">
	</td>
    </tr>
	<tr>
    <td>Address:</td>
    <td style="background-color:white;">
        <input type="text1" name="address" id="address" placeholder="Address" style="text-align:center;">
	</td>
    </tr>
	<tr>
	<td>Date of Good arrival:</td>
	<td style="background-color:white;">
        <input type="date" name="darrival" id="darrival">
	</td>
    </tr>
	<tr>
	<td>Sender's name:</td>
	<td style="background-color:white;">
        <input type="text1" name="sdname" id="sdname" placeholder="Sender Name" style="text-align:center;">
	</td>
    </tr>
	<tr>
	<td>Sender's Phone Number:</td>
    <td style="background-color:white;">
        <input type="text1" name="sdphone" id="sdphone" placeholder="Sender Phone Number" style="text-align:center;">
	</td>
    </tr>
	<tr>
	<td>Status:</td>
	<td style="background-color:white;">
			<input type="checkbox" id="received" name="status" value="received">
			<label for="received">Received</label>	
			<input type="checkbox" id="collected" name="status" value="collected">
			<label for="collected">Collected</label>
	</td>
    </tr>
	</table>
	<br>
    <button class="input">Insert</button>
</form>
</div>
