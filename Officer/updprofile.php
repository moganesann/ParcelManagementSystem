...
<div class="row">
  ...
  <h2>Update Data</h2>
  <form action="updprofile2.php" method="post">
  <table border='1' class="table3">
	<tr>
	<td>Type of Goods:</td>
	<td style="background-color:white;">
		  <input type="checkbox" id="parcel" name="typegoods" value="Parcel">
		  <label for="parcel">Parcel</label>
			
		  <input type="checkbox" id="mail" name="typegoods" value="Mail">
	...
	<td style="background-color:white;">
        <input type="text1" name="name" id="name" value="<?php echo (isset($_POST["name"]))?$_POST["name"]:'';?>" placeholder="Student Name" style="text-align:center;">
	</td>
    </tr>
    <tr>
	<td>Student's ID:</td>
	<td style="background-color:white;">
        <input type="text1" name="id" id="id" value="<?php echo (isset($_POST["id"]))?$_POST["id"]:'';?>" readonly style="text-align:center;">
	</td>
    </tr>
	<tr>
	<td>Phone Number:</td>
    <td style="background-color:white;">
        <input type="text1" name="phone" id="phone" value="<?php echo (isset($_POST["phone"]))?$_POST["phone"]:'';?>" placeholder="Phone Number" style="text-align:center;">
	</td>
    </tr>
	<tr>
    <td>Address:</td>
    <td style="background-color:white;">
        <input type="text1" name="address" id="address" value="<?php echo (isset($_POST["address"]))?$_POST["address"]:'';?>" placeholder="Address" style="text-align:center;">
	</td>
    </tr>
	<tr>
	<td>Date of Good arrival:</td>
	<td style="background-color:white;">
        <input type="date" name="darrival" id="darrival" value="<?php echo (isset($_POST["darrival"]))?$_POST["darrival"]:'';?>" >
	</td>
    </tr>
	<tr>
	<td>Sender's name:</td>
	<td style="background-color:white;">
        <input type="text1" name="sdname" id="sdname" value="<?php echo (isset($_POST["sdname"]))?$_POST["sdname"]:'';?>" placeholder="Sender Name" style="text-align:center;">
	</td>
    </tr>
	<tr>
	<td>Sender's Phone Number:</td>
    <td style="background-color:white;">
        <input type="text1" name="sdphone" id="sdphone" value="<?php echo (isset($_POST["sdphone"]))?$_POST["sdphone"]:'';?>" placeholder="Sender Phone Number" style="text-align:center;">
	</td>
    </tr>
	</table>
	<br>
