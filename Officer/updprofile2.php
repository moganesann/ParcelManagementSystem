...
$sql = "Update activelist SET typegoods='".$_POST['typegoods']."',name='".$_POST['name']."', id='".$_POST['id']."' , phone='".$_POST['phone']."' , address='".$_POST['address']."' , darrival='".$_POST['darrival']."', sdname='".$_POST['sdname']."' , sdphone='".$_POST['sdphone']."' WHERE id ='".$_POST['id']."' ";
...
?>
    <br> <br> <button class="input" onclick="window.location.href='searchlist.php'">Back</button>
