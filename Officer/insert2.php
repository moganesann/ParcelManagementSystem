...
$typegoods = mysqli_real_escape_string($link, $_REQUEST['typegoods']);
$name = mysqli_real_escape_string($link, $_REQUEST['name']);
$id = mysqli_real_escape_string($link, $_REQUEST['id']);
$phone = mysqli_real_escape_string($link, $_REQUEST['phone']);
$address = mysqli_real_escape_string($link, $_REQUEST['address']);
$darrival = mysqli_real_escape_string($link, $_REQUEST['darrival']);
$sdname = mysqli_real_escape_string($link, $_REQUEST['sdname']);
$sdphone = mysqli_real_escape_string($link, $_REQUEST['sdphone']);
$status = mysqli_real_escape_string($link, $_REQUEST['status']);
 
// Attempt insert query execution
$sql = "INSERT INTO activelist (typegoods, name,id,phone,address,darrival,sdname,sdphone,status) VALUES ('$typegoods', '$name', '$id','$phone','$address','$darrival','$sdname','$sdphone','$status')";
...
?>
<br><br>
  <button class="input" onclick="document.location='searchlist.php'">Back</button>
</div>
